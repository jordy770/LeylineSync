-- supabase/functions_src/card_has_lifelink.sql
-- CANONICAL (mig 283): lifelink accessor, cloned from card_has_trample
-- (newest def: 202605010200_keyword_grant_filters.sql, verified per bug-682).
