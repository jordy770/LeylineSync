-- 202605010346_reanimate_spell
-- Reanimate / Animate Dead via return_from_graveyard in the spell resolver.
-- apply_trigger_effects carries a lose_life_mana_value rider into the return pick;
-- submit_decision makes the decider lose life equal to the summed MV of the
-- returned cards (Reanimate). Animate Dead omits the Aura/-1/-0/sac-on-leave.
