-- 202605010303_pacify
-- Pacify (mig 303, Observed Stasis). A cant_attack / cant_block continuous
-- effect on a creature (an Aura with affected:enchanted) forbids it from
-- attacking (declare_attacker) or blocking (declare_blocker); register_card_
-- continuous_effects whitelists the two new types. They revert when the Aura
-- leaves. (Observed Stasis loses-all-abilities clause + ETB are not modelled.)
-- Generated from supabase/functions_src (declare_attacker, declare_blocker, register_card_continuous_effects) — those files are
-- the canonical current definitions; edit them, not past migrations.

-- Non-function DDL: cant_attack / cant_block join the allowed effect types.
