-- Necrotic Hex — "Each player sacrifices six creatures of their choice. You create
-- six tapped 2/2 black Zombie tokens." Adds who:'each_player' to the sacrifice edict
-- (every player including the caster, in seat order). The fixed tapped-token half
-- already works. Reproduces apply_trigger_effects (mig 197) by exact line range.
