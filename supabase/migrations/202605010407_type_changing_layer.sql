-- 202605010407_type_changing_layer
-- TODO: describe the change.
-- Generated from supabase/functions_src (effective_type_line, register_card_continuous_effects, fire_watcher_triggers, apply_trigger_effects, submit_decision) — those files are
-- the canonical current definitions; edit them, not past migrations.

-- 'granted_type' joins the continuous-effect CHECK list (rebuilt from the
-- mig 406 definition + the new value — bug-283 rule).
