-- 202605010298_syphon_mind
-- Each-opponent discard + num_opponents count (mig 298). The discard effect gains
-- who:'each_opponent'/'each_player' (every (other) player discards N cards, at
-- random/immediate — the chooser nuance is approximated), and resolve_count_amount
-- gains num_opponents. Together they script Syphon Mind ("each other player
-- discards a card; you draw a card for each card discarded this way").
-- Generated from supabase/functions_src (apply_trigger_effects, resolve_count_amount) — those files are
