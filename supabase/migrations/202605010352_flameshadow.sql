-- 202605010352_flameshadow
-- Flameshadow Conjuring: the may decision now carries triggering_card_id, and the
-- confirm-program path enqueues with it preserved, so a reflexive
-- copy_permanent target:'triggering_creature' keeps its subject after a may.
