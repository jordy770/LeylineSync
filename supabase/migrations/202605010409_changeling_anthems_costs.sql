-- 202605010409_changeling_anthems_costs
-- TODO: describe the change.
-- Generated from supabase/functions_src (card_has_creature_type, activate_ability, card_layered_power, card_layered_toughness) — those files are
...
begin
  ...
  if v_has_sac_creature then
    ...
    -- clear it, mirroring the discard-cost pattern above.
    p_target_card_id := null;
  end if;
