-- 202605010287_turn_state_monarch
-- Client state badges (mig 287): get_turn_state returns monarch_player_id
-- (return-type change — drop first).

drop function if exists public.get_turn_state(uuid);
