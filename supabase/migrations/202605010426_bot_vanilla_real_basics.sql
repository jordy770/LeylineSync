...
begin
  ...
  -- Real basics ONLY (bug-2699): custom cards like "Barry's Land" (type
  -- 'Basic Land — Cloud') sort alphabetically before Forest and used to become
  -- the bot's entire (untappable) manabase via 'order by name limit 1'.
  select id into v_land from public.cards
