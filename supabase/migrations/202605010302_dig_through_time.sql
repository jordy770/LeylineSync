-- 202605010302_dig_through_time
-- look_top to:'hand' + multi-pick (mig 302, Dig Through Time). The look_top
-- decision can now put the chosen cards into HAND (not just battlefield/exile),
-- and `picks` sets how many to take (default 1). Dig Through Time digs 7, puts 2
-- into hand, bottoms the rest. (Delve is omitted — cast at full cost.)
