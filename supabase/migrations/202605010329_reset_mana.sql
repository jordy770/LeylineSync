-- 202605010329_reset_mana
-- New reset_mana RPC: "undo tap mana" — untaps the caller's tapped mana sources
-- (lands + mana-ability permanents) and empties their floating pool. Trust-based.
-- Generated from supabase/functions_src (reset_mana) — those files are
