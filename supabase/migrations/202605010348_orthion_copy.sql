-- 202605010348_orthion_copy
-- Orthion: copy_permanent from an activated ability (added to activate_ability's
-- single-effect spell_effect routing) + a count parameter (create N token copies,
-- threaded through the copy_permanent decision params into submit_decision).
-- Generated from supabase/functions_src (activate_ability, apply_trigger_effects, submit_decision) — those files are
