...
- `apply_triggered_ability_effects.sql` — supabase/functions_src/apply_triggered_ability_effects.sql (~7890 tok)
...
- `fire_watcher_triggers.sql` — supabase/functions_src/fire_watcher_triggers.sql (~1875 tok)
