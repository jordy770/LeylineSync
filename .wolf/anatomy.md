...
- `script-deck-batch-wf_a93d3b00-a56.js` — Exports meta (~1903 tok)
...
- `Absorb.json` (~49 tok)
- `AmbitionsCost.json` (~53 tok)
- `AngelOfDespair.json` (~90 tok)
- `AngelOfSerenity.json` (~93 tok)
- `AngrathsRampage.json` (~262 tok)
- `AnguishedUnmaking.json` (~67 tok)
- `AnOfferYouCantRefuse.json` (~36 tok)
- `ArborElf.json` (~51 tok)
- `Archaeomancer.json` (~73 tok)
- `AspectOfHydra.json` (~76 tok)
- `AssassinsTrophy.json` (~69 tok)
- `AureliaTheWarleader.json` (~155 tok)
- `AvenWindMage.json` (~149 tok)
- `AwakeningZone.json` (~100 tok)
- `BadMoon.json` (~52 tok)
- `Baral-Chief-of-Compliance.json` (~106 tok)
- `Bitterblossom.json` (~82 tok)
- `BituminousBlast.json` (~42 tok)
- `BlinkOfAnEye.json` (~46 tok)
- `BloodfellCaves.json` (~135 tok)
- `BloodgiftDemon.json` (~133 tok)
- `BlossomingDefense.json` (~109 tok)
- `BlueSunsZenith.json` (~33 tok)
- `BoneShredder.json` (~90 tok)
- `BorealDruid.json` (~61 tok)
- `BorosCharm.json` (~205 tok)
- `BrasssBounty.json` (~51 tok)
- `BurnishedHart.json` (~112 tok)
- `ButcherGhoul.json` (~13 tok)
- `ButcherOfMalakir.json` (~113 tok)
- `Cancel.json` (~43 tok)
- `CarefulStudy.json` (~48 tok)
- `CarrionFeeder.json` (~96 tok)
- `CasualtiesOfWar.json` (~402 tok)
- `CausticCaterpillar.json` (~81 tok)
- `CharcoalDiamond.json` (~68 tok)
- `ChartACourse.json` (~48 tok)
- `CliffhavenVampire.json` (~92 tok)
- `CloudkinSeer.json` (~80 tok)
- `CoalitionRelic.json` (~61 tok)
- `CompulsiveResearch.json` (~48 tok)
- `Condescend.json` (~32 tok)
- `Consider.json` (~57 tok)
- `CorpseKnight.json` (~74 tok)
- `CostlyPlunder.json` (~60 tok)
- `Counterflux.json` (~45 tok)
- `Counterspell.json` (~36 tok)
- `CraterhoofBehemoth.json` (~155 tok)
- `CreepingCorrosion.json` (~37 tok)
- `Crusade.json` (~52 tok)
- `Curate.json` (~57 tok)
- `DamnablePact.json` (~54 tok)
- `DayOfJudgment.json` (~31 tok)
- `DeadlyDispute.json` (~81 tok)
- `DiabolicTutor.json` (~39 tok)
- `DidntSayPlease.json` (~74 tok)
- `DiregrafGhoul.json` (~15 tok)
- `DiscipleOfTheVault.json` (~105 tok)
- `DisturbedBurial.json` (~63 tok)
- `DovinsVeto.json` (~45 tok)
- `DreadhordeInvasion.json` (~146 tok)
- `DreadWanderer.json` (~137 tok)
- `DreamFracture.json` (~85 tok)
- `DwynenGiltLeafDaen.json` (~144 tok)
- `ElvesOfDeepShadow.json` (~61 tok)
- `ElvishArchdruid.json` (~63 tok)
- `ElvishClancaller.json` (~173 tok)
- `ElvishMystic.json` (~61 tok)
- `ElvishPromenade.json` (~67 tok)
- `ElvishVisionary.json` (~42 tok)
- `ElvishWarmaster.json` (~212 tok)
- `EndRazeForerunners.json` (~197 tok)
- `EpicureOfBlood.json` (~59 tok)
- `EssenceScatter.json` (~43 tok)
- `EternalWitness.json` (~105 tok)
- `ExclusionMage.json` (~76 tok)
- `ExplosiveVegetation.json` (~76 tok)
- `EzuriRenegadeLeader.json` (~126 tok)
- `Fabricate.json` (~55 tok)
- `FarhavenElf.json` (~93 tok)
- `FinaleOfRevelation.json` (~33 tok)
- `FireDiamond.json` (~68 tok)
- `FlameSlash.json` (~42 tok)
- `FranticSearch.json` (~68 tok)
- `FromUnderTheFloorboards.json` (~59 tok)
- `FrostTitan.json` (~90 tok)
- `FyndhornElves.json` (~61 tok)
- `Gadwick-the-Wizened.json` (~98 tok)
- `GaeasAnthem.json` (~49 tok)
- `GatherTheTownsfolk.json` (~42 tok)
- `GhoulcallersChant.json` (~247 tok)
- `GildedLotus.json` (~61 tok)
- `Gisela-Blade-of-Goldnight.json` (~68 tok)
- `GloriousAnthem.json` (~49 tok)
- `GoblinBombardment.json` (~72 tok)
- `GolgariCharm.json` (~239 tok)
- `GolgariFindbroker.json` (~83 tok)
- `Gravecrawler.json` (~55 tok)
- `GraveTitan.json` (~125 tok)
- `GreatOakGuardian.json` (~114 tok)
- `GrimHaruspex.json` (~72 tok)
- `GrowFromTheAshes.json` (~69 tok)
- `GuardianIdol.json` (~61 tok)
- `HedronArchive.json` (~119 tok)
- `HerosDownfall.json` (~42 tok)
- `HonorOfThePure.json` (~54 tok)
- `HourOfReckoning.json` (~38 tok)
- `IdyllicTutor.json` (~56 tok)
- `ImpassionedOrator.json` (~64 tok)
- `ImperiousPerfect.json` (~141 tok)
- `InfernoTitan.json` (~280 tok)
- `IntangibleVirtue.json` (~89 tok)
- `IntoTheRoil.json` (~46 tok)
- `Ionize.json` (~44 tok)
- `IzzetSignet.json` (~100 tok)
- `JacesIngenuity.json` (~32 tok)
- `JuriMasterOfTheRevue.json` (~65 tok)
- `KalainReclusivePainter.json` (~61 tok)
- `Kokusho.json` (~122 tok)
- `LeadTheStampede.json` (~63 tok)
- `LightningHelix.json` (~46 tok)
- `LlanowarElves.json` (~61 tok)
- `LlanowarTribe.json` (~61 tok)
- `LlanowarVisionary.json` (~95 tok)
- `LordOfTheUndead.json` (~126 tok)
- `MaelstromPulse.json` (~40 tok)
- `Mahadi-Emporium-Master.json` (~91 tok)
- `MakeAStand.json` (~90 tok)
- `MarchOfWretchedSorrow.json` (~76 tok)
- `MarionetteMaster.json` (~292 tok)
- `MayhemPatrol.json` (~92 tok)
- `MentalNote.json` (~66 tok)
- `MercilessExecutioner.json` (~76 tok)
- `MerenOfClanNelToth.json` (~143 tok)
- `MeteorGolem.json` (~89 tok)
- `MindGames.json` (~36 tok)
- `MurmuringMystic.json` (~117 tok)
- `MysticSanctuary.json` (~132 tok)
- `Naru-Meha-Master-Wizard.json` (~75 tok)
- `Naturalize.json` (~42 tok)
- `NaturesLore.json` (~68 tok)
- `NaturesSpiral.json` (~103 tok)
- `Negate.json` (~36 tok)
- `NissasPilgrimage.json` (~126 tok)
- `NoxiousGhoul.json` (~112 tok)
- `Oblation.json` (~41 tok)
- `Opportunity.json` (~64 tok)
- `OrzhovSignet.json` (~100 tok)
- `Overrun.json` (~68 tok)
- `OverwhelmingStampede.json` (~102 tok)
- `Peek.json` (~32 tok)
- `PlagueBelcher.json` (~171 tok)
- `Plaguecrafter.json` (~76 tok)
- `PoisonTipArcher.json` (~136 tok)
- `PrimevalTitan.json` (~195 tok)
- `PrismaticLens.json` (~116 tok)
- `PullFromTomorrow.json` (~49 tok)
- `QueensCommission.json` (~44 tok)
- `RaiseTheAlarm.json` (~42 tok)
- `RangersGuile.json` (~109 tok)
- `RangersPath.json` (~74 tok)
- `RecklessFireweaver.json` (~79 tok)
- `ReclamationSage.json` (~61 tok)
- `RegalForce.json` (~57 tok)
- `Regrowth.json` (~116 tok)
- `ReliquaryTower.json` (~61 tok)
- `Remand.json` (~48 tok)
- `RenderSilent.json` (~36 tok)
- `ReturnToDust.json` (~46 tok)
- `ReturnToNature.json` (~237 tok)
- `Rewind.json` (~56 tok)
- `RipApart.json` (~132 tok)
- `RootbornDefenses.json` (~56 tok)
- `RottingRegisaur.json` (~55 tok)
- `SakuraTribeElder.json` (~94 tok)
- `SanguineBond.json` (~62 tok)
- `SecretsOfTheGoldenCity.json` (~89 tok)
- `SelesnyaSignet.json` (~100 tok)
- `ServoExhibition.json` (~41 tok)
- `ShadowRift.json` (~32 tok)
- `ShatteringSpree.json` (~37 tok)
- `Shatterstorm.json` (~37 tok)
- `ShepherdOfRot.json` (~166 tok)
- `ShipwreckDowser.json` (~166 tok)
- `Shriekmaw.json` (~91 tok)
- `SidisiUndeadVizier.json` (~199 tok)
- `SimicSignet.json` (~100 tok)
- `SkyshroudClaim.json` (~68 tok)
- `SlipThroughSpace.json` (~32 tok)
- `SnakeskinVeil.json` (~104 tok)
- `SolveTheEquation.json` (~59 tok)
- `SpectralProcession.json` (~42 tok)
- `staples21-BaneOfProgress.json` (~60 tok)
- `staples21-DemonsDisciple.json` (~76 tok)
- `staples21-Duplicant.json` (~61 tok)
- `staples21-TerrorOfMountVelus.json` (~126 tok)
- `staples21-WurmcoilEngine.json` (~146 tok)
- `StrokeOfGenius.json` (~33 tok)
- `SuturePriest.json` (~195 tok)
- `SylvanCaryatid.json` (~130 tok)
- `TalismanOfCuriosity.json` (~201 tok)
- `TalismanOfResilience.json` (~201 tok)
- `TalismanOfUnity.json` (~201 tok)
- `Talrand.json` (~112 tok)
- `TamiyosSafekeeping.json` (~128 tok)
- `ThoughtScour.json` (~102 tok)
- `ThranDynamo.json` (~61 tok)
- `ThundermawHellkite.json` (~66 tok)
- `Tidings.json` (~32 tok)
- `TreasureCruise.json` (~32 tok)
- `TriplicateSpirits.json` (~42 tok)
- `UnbreakableFormation.json` (~196 tok)
- `UndeadWarchief.json` (~51 tok)
- `UtterEnd.json` (~39 tok)
- `validate-abs.mts` — Same as validate-one.mts but resolves the engine schema via a file:// URL so it (~162 tok)
- `validate-one-abs.mts` — Validate ONE card-behavior script JSON file against the real engine schema. (~142 tok)
- `validate-one-chunk8.mts` — Validate ONE card-behavior script JSON file against the real engine schema. (~149 tok)
- `validate-one-fileurl.mts` — Validate ONE card-behavior script JSON file against the real engine schema. (~142 tok)
- `validate-one.mts` — Validate ONE card-behavior script JSON file against the real engine schema. (~147 tok)
- `verify-1-1.json` (~301 tok)
- `verify-1-2.json` (~13 tok)
- `verify-1-3.json` (~127 tok)
- `verify-1-4.json` (~15 tok)
- `verify-1-5.json` (~160 tok)
- `verify-1-6.json` (~63 tok)
- `verify-10-1.json` (~37 tok)
- `verify-10-2.json` (~37 tok)
- `verify-10-3.json` (~38 tok)
- `verify-11-1.json` (~215 tok)
- `verify-11-2.json` (~168 tok)
- `verify-11-3.json` (~173 tok)
- `verify-11-4.json` (~173 tok)
- `verify-11-5.json` (~105 tok)
- `verify-17-1.json` (~48 tok)
- `verify-17-2.json` (~32 tok)
- `verify-17-3.json` (~36 tok)
- `verify-17-4-landtest.json` (~42 tok)
- `verify-17-bonesplitter.json` (~68 tok)
- `verify-17-heroic-intervention.json` (~72 tok)
- `verify-17-razakeths-rite.json` (~45 tok)
- `verify-17-time-of-need.json` (~71 tok)
- `verify-25-1.json` (~66 tok)
- `verify-25-2.json` (~133 tok)
- `verify-29-1.json` (~61 tok)
- `verify-29-2.json` (~61 tok)
- `verify-29-4.json` (~74 tok)
- `verify-35-1.json` (~163 tok)
- `verify-7-2.json` (~104 tok)
- `verify-7-3.json` (~98 tok)
- `verify-7-5.json` (~131 tok)
- `verify-7-6.json` (~106 tok)
- `VitoThornOfTheDuskRose.json` (~125 tok)
- `WeeDragonauts.json` (~149 tok)
- `WildbornPreserver.json` (~47 tok)
- `WilheltTheRotcleaver.json` (~227 tok)
- `WirewoodChanneler.json` (~92 tok)
- `WirewoodLodge.json` (~112 tok)
- `WizardsRetort.json` (~73 tok)
- `WoodElves.json` (~84 tok)
- `WornPowerstone.json` (~61 tok)
- `WrathOfGod.json` (~31 tok)
- `YoungPyromancer.json` (~117 tok)
...
- `ezuri-elves.txt` — Ezuri, Renegade Leader — mono-green elves (100 cards) (~291 tok)
- `kaalia-angels.txt` — Kaalia of the Vast — WBR angels, demons & dragons (100 cards) (~338 tok)
- `meren-graveyard.txt` — Meren of Clan Nel Toth — BG graveyard value (100 cards) (~320 tok)
- `prosper-treasures.txt` — Prosper, Tome-Bound — BR exile & treasures (100 cards) (~322 tok)
- `staples.txt` — EDH staples — most-played cards across uploaded decks (not a playable deck; (~1040 tok)
- `talrand-spellslinger.txt` — Talrand, Sky Summoner — mono-blue spellslinger (100 cards) (~287 tok)
- `wilhelt-zombies.txt` — Wilhelt, the Rotcleaver — UB zombie tribal (100 cards) (~321 tok)
