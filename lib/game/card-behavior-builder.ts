...
export const BUILDER_TRIGGER_EVENTS = [
  ...
  { value: 'spell_cast', label: 'When a spell is cast (use filter: Instant/Sorcery/…)' },
] as const
...
export const BUILDER_WATCHER_EVENTS = ['creature_entered', 'creature_died', 'creature_got_counter', 'creature_left', 'creature_attacks', 'spell_cast'] as const
